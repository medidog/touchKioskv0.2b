...
(function (factory) {
	...
	$.BigVideo = function(options) {
		...
		function initPlayControl() {
			...
			markup += '<a href="MC-31-video.html" id="big-video-control-rewind"></a>';
			...
			markup += '<a href="MC-31-screen.html" id="big-video-control-foward"></a>';
		...
		BigVideo.init = function() {
			...
			// CHANGE THE NAME ACCORDING TO THE NEXT PAGE (**-**-screen.html)
				player.on('ended', function() {
					if (settings.doLoop) {
						window.location = "MC-31-screen.html";
					}
					if (isQueued) {
						window.location = "MC-31-screen.html";
					}
